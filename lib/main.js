$(function() {
	...
	var localToDGB=function(value) {
		var usd=value*1;			// ****************************need to add actual exchange rate info.
		var dgb=Math.ceil(config.rate(value)*1000000)/1000000;	//leaving 6 digits percision.  if need to can use last 2 to make transaction unique
		return dgb;
	}
